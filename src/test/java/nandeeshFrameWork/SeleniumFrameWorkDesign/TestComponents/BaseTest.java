...
public class BaseTest {
	...
	
	{
		...
		FileInputStream fis = new FileInputStream(System.getProperty("user.dir")
				+"//src//main//java//nandeeshFrameWork//resources//GlobalData.properties");
		prop.load(fis);
		//use below when we run on the maven using maven synter -Dbroser=--- (like Chrome/Firefox/edge)
		String broserName = System.getProperty("browser")!= null ? System.getProperty("browser") : prop.getProperty("browser");
		//use below when we run only on the broser (like Chrome/Firefox/edge)  
...
//			WebDriver driver = new FirefoxDriver();
			System.setProperty("webdriver.gecko.driver", "C:/Users/03685M744/Desktop//Driver//geckodriver.exe");
